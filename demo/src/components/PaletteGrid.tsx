...
import { crayola, fs595c, ntc, pantone, web, x11, xkcd } from 'chromonym';
...
export const PALETTES = { web, x11, pantone, crayola, ntc, xkcd, fs595c } as const;
...
export const PALETTE_KEYS = ['web', 'x11', 'pantone', 'crayola', 'ntc', 'xkcd', 'fs595c'] as const satisfies readonly PaletteKey[];
